          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-amber-800 space-y-1.5">
                ...
                <p>DrX Consult is a <span className="font-semibold">booking facilitator only</span>, not a healthcare provider. All medical services are provided solely by the respective hospitals.</p>
                <p>The payment collected (₹49) is a <span className="font-semibold">token amount only</span> to initiate your booking — it is not the total cost of the service. Final charges will be determined by the hospital.</p>
                <p>After booking confirmation, you must <span className="font-semibold">arrive at the hospital within 90 minutes</span> and provide your OTP to the hospital staff to confirm your reservation. Failure to arrive within 90 minutes will result in automatic cancellation of your booking.</p>
              </div>
            </div>
          </div>
